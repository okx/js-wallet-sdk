...
describe("kaspa", () => {
    ...
    test("signCommonMsg", async () => {
        ...
        assert.strictEqual(sig,"1c96f99670d2685250aed3a633e5e37d15b0ee26e6e360fc35df7b00ea117e5e706f93a16291fedb829f9307dd03678f0d2178bf4011ed19fa4200f94f6b294270")
    });
