...
export async function cat20transferV2(param: SignTxParams) {
  ...
  return {
    commitTx: sendInfo.guardTx.extractTransaction().toHex(),
    revealTx: sendInfo.sendTx.extractTransaction().toHex(),
  };
}
