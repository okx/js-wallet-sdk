...
import * as convertBits from "./convertBits"
 ...
 */
export function encode(prefix: string, type: string, hash: Uint8Array) {
 ...
 * @returns {Uint8Array}
 */
function checksumToUint5Array(checksum: BigInteger) {
 ...
 * @throws {ValidationError}
 */
function getHashSizeBits(hash: Uint8Array) {
 ...
 * @returns {Uint8Array}
 */
function toUint5Array(data: Uint8Array) {
 ...
 * @returns {Uint8Array}
 */
function fromUint5Array(data: Uint8Array) {
 ...
 * @param str
 */
function hasSingleCase(str: string) {
