...
test("signCommonMsg", async () => {
    ...
    expect(sig).toEqual("1b523031d0c4a2de1a88fb02015a0d1bd3c6ef6e6834f7a4ba72020b192f3a92291868a9838eccfacce84125ed97eec9255da9cf7137be02cb863fe6436dbdb5e3");
    ...
    expect(sig).toEqual("1b182c85a550a32f562da2c4b22bc6947f4ca21369628dd24cd0072b8bd121450234ed4fd1392b4e35b65c7ae9e1962926ffa6fcb774cbec1616ae86533b0c6c00");
    ...
    expect(sig).toEqual("1ba835a8b34530a3f4799fd102a95ee7313a2b8cf50724778ef687a3387f50cdb342a29af889d7b6668def38820c28778e9f4fe4fdcd99e4cc3a68d4576a6bd575");
});
...
test('token-transfer', async () => {
    ...
    console.log(tx)
    expect(tx.txSerializedHexString).toEqual("")
});
...
test('allowContractCaller', async () => {
    ...
    console.log(tx)
    expect(tx.txSerializedHexString).toEqual("")
    expect(tx.txId).toEqual("0x64f7d7597becbcc008f9ecef665c2dd9b875db8a0cb40d0fc220c8c9067a19a6");
})
...
test('delegateStx', async () => {
    ...
    console.log(tx)
    expect(tx.txSerializedHexString).toEqual("")
    expect(tx.txId).toEqual("0xcba9cb0d0367697fec1d9ed2b597331464b1b0ee68766c7a4c6cf1e88eceae40");
});
...
test('revokeDelegateStx', async () => {
    ...
    console.log(tx)
    expect(tx.txSerializedHexString).toEqual("")
    expect(tx.txId).toEqual("0x74486c2574aae64dc9d2c607d336de6c442206a29232c998e9a2ce8a797e9066");
});