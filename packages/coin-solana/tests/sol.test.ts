    ...
    */
    ...
    test('getMPCRawTransaction', async () => {
        ...
        let params = {
            data: {
                type: "transfer",
                payer: "7HXFk3MPHALNugrF1D7RqTNeaFxBsG6yA6wRLigUiB4v",
                blockHash: "6t1qEvLH5uC9NMmMTPhaE9tAaWdk1qvBjqsKsKNPB7sX",
                from: "7HXFk3MPHALNugrF1D7RqTNeaFxBsG6yA6wRLigUiB4v",
                to: "7NRmECq1R4tCtXNvmvDAuXmii3vN1J9DRZWhMCuuUnkM",
                amount: 100000000
            }
        }
        const {raw} = await wallet.getMPCRawTransaction(params);
        expect(raw).toBe("");
    });
