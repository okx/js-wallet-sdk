import {changePubkey, transfer, ZkspaceWallet} from '../src';

describe("zkspace", () => {

    test("changepubkey", async () => {
        let wallet = new ZkspaceWallet();
        const {address} = await wallet.getNewAddress({privateKey:"bdd80f4421968142b3a4a6c27a1d84a3623384d085a04a895f109fd8d49cef0a"});
        ...
        const expected = "{\"type\":\"ChangePubKey\",\"accountId\":11573,\"account\":\"0x5d4d48eb6e9677b0d91f8fb77b419591e5c625ee\",\"newPkHash\":\"sync:1a15456df95b1af2cdc390b7c303dd389bdabf0b\",\"nonce\":2,\"ethSignature\":\"0xa0cd2dbed420d529d23dab710877eab3ea06deb4240e789ec0dd4792bee46bb862b8938944ea4657100b33c7da88e9cbe76ba6dada3726720d741bed06347aac1c\",\"txHash\":\"0x9413872b6a87bc622f26da6083a40dd5878a0cd4f45f7601c6ca3a4c5a98cafd\"}";
